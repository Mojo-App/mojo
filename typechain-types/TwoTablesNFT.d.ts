...
interface TwoTablesNFTInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "baseURIString",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class TwoTablesNFT extends BaseContract {
  ...
  interface: TwoTablesNFTInterface;
